...
Cuốn sách này kể về **Andie** — một người hoàn toàn bình thường, không có background toán hay kỹ thuật — và hành trình cậu học cách "nghe" data nói. Qua từng tình huống công việc thực tế, bạn sẽ học được **9 Lens** — 9 góc nhìn bất biến, apply được cho mọi ngành, mọi loại dữ liệu.
